...
const ChatIndex: NextPage = () => {
	...
	const users: UserList[] = [
		{ id: 1, name: "橋本 環奈", userid:"@100_angel", icon: IconImage.src, background: backgroundImage.src, time: "17:00"},
		{ id: 2, name: "永野 芽郁", userid:"@nagamo_mei", icon: IconImage.src, background: backgroundImage.src, time: "17:00"},
		{ id: 3,  name: "剛力 彩芽", userid:"@okanekubari", icon: IconImage.src, background: backgroundImage.src, time: "17:00"},
		{ id: 4, name: "なえなの", userid:"@naenano", icon: IconImage.src, background: backgroundImage.src, time: "17:00"},
		{ id: 5, name: "中野 二乃", userid:"@nakano_2", icon: IconImage.src, background: backgroundImage.src, time: "17:00"},
	]
